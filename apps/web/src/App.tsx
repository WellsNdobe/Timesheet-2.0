...
type IconName = "grid" | "clock" | "folder" | "chart" | "users" | "settings" | "search" | "filter" | "list" | "more" | "chevron" | "chevron-left" | "chevron-right" | "calendar" | "play" | "pause" | "arrow" | "check" | "warning" | "plus" | "help" | "close" | "bell";
...
function TimesheetPage() {
  ...
  return <>
    ...
    <div className="timesheet-toolbar"><div className="timesheet-period"><button className="icon-button timesheet-period__arrow" type="button" aria-label="Previous week"><Icon name="chevron-left" size={16} /></button><button className="subtle-button" type="button"><Icon name="calendar" size={14} /> Mar 10 – 16, 2025 <Icon name="chevron" size={13} /></button><button className="icon-button timesheet-period__arrow" type="button" aria-label="Next week"><Icon name="chevron-right" size={16} /></button></div><div className="timesheet-toolbar__actions"><button className="subtle-button" type="button">Copy last week</button><button className="primary-button" type="button" onClick={addRow}><Icon name="plus" size={16} /> Log time</button></div></div>
